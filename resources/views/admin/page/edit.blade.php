              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $page['name']) }}">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" type="checkbox" id="status" value="1" name="status" <?php echo ($page['status'] == 1) ? 'checked' : ''?>>
