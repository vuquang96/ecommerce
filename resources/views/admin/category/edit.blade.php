              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        <textarea class="textarea @error('description') is-invalid @enderror" name="description"   value="{{ old('description', $category['description']) }}" placeholder="Place some text here"
                  ...
                  <div class="form-group row">
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" type="checkbox" id="status" value="1" name="status" <?php echo ($category['status'] ? 'checked' : ''); ?>>
